    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let selected = devices?[(indexPath as NSIndexPath).row] {
            ...
            selected.connect(withTimeoutAsync: 15).success { _ in
                ...
                let alert = UIAlertController(title: "Confirm Device", message: "Do you see a blinking green LED on the sensor", preferredStyle: UIAlertControllerStyle.alert)
